...
Tome-se o caso de uma parede de tijolos em um corredor de jogo. Uma equipe iniciante, sem o vocabulário deste capítulo bem assentado, tende a tratar "a parede de tijolos" como uma coisa só: uma imagem de tijolos colada sobre um plano. O resultado costuma ser decepcionante. Sob qualquer luz que não seja perfeitamente frontal, a parede revela sua natureza plana, pois a fotografia de tijolos não reage à iluminação — ela já traz sombras "pintadas" que não correspondem às luzes reais da cena. Quando o jogador aproxima uma tocha, a parede não responde; as reentrâncias entre os tijolos não escurecem, as faces salientes não se iluminam.

Uma equipe que domina os conceitos aborda o mesmo problema decompondo a parede em propriedades. A cor base descreve apenas a coloração do barro e da argamassa, sem qualquer sombra embutida. Uma textura adicional descreve o relevo, informando ao material onde a superfície recua (as juntas de argamassa) e onde avança (as faces dos tijolos). Outra textura descreve a rugosidade, distinguindo a aspereza do tijolo do acabamento ligeiramente mais liso da argamassa. Quando a tocha se aproxima, o material, alimentado por essas texturas, calcula corretamente como cada ponto reage: as juntas mergulham na sombra, as quinas captam a luz, e a parede ganha vida. A diferença entre os dois resultados não está na habilidade artística de desenhar tijolos, mas na compreensão de que aparência, em computação gráfica, é o produto de dados e luz — não uma imagem estática.

> Figura: Comparação entre uma parede tratada como imagem única e a mesma parede decomposta em mapas de propriedade, ambas sob uma fonte de luz lateral, evidenciando a ausência e a presença de resposta ao relevo.
>
> **Screenshot sugerido:**
> Duas renderizações da mesma parede com uma luz pontual posicionada à esquerda: uma usando apenas cor base "fotográfica" e outra usando cor base limpa acompanhada de mapa de relevo. Posicionar as imagens lado a lado para comparação direta.
