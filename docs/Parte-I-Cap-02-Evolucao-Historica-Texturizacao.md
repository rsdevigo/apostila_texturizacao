...
> **Figura 2.1** — Diagrama extraído do paper de Lagarde e de Rousiers mostrando as faixas de valores de albedo fisicamente corretos para metais e dielétricos. O gráfico estabelece os limites numéricos dentro dos quais qualquer textura PBR deve operar para produzir resultados plausíveis em qualquer iluminação.
>
> **Fonte da imagem:** Sébastien Lagarde & Charles de Rousiers — *"Moving Frostbite to Physically Based Rendering"*, SIGGRAPH 2014. Disponível em: `https://seblagarde.wordpress.com/2015/07/14/siggraph-2014-moving-frostbite-to-physically-based-rendering/` (acesso aberto, com slides completos).
